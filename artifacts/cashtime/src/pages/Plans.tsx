  ...
  return (
    <div className="screen" style={{ paddingBottom: 30 }}>
      ...
      <div className="plan-card plan-card-free">
        ...
        <button className="btn btn-ghost" style={{ fontSize: "clamp(12px,3.3vw,14px)", padding: 12 }} onClick={() => navigate("/post")}>
          Publicar por R$9,90
        </button>
      </div>
      ...
      <div className="plan-card plan-card-pro">
        ...
        <button className="btn btn-primary" style={{ fontSize: "clamp(12px,3.3vw,14px)", padding: 13 }} onClick={() => navigate("/profile")}>
