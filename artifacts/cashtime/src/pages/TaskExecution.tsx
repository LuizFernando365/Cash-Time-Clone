  ...
  return (
    <div className="screen" style={{ paddingBottom: 30 }}>
      <div style={{ padding: "16px 22px 8px" }}>
        <div style={{ fontSize: 12, color: "#7E7A9A", marginBottom: 4 }}>TAREFA ACEITA</div>
        <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 18, fontWeight: 700 }}>Confirmação de início</div>
      </div>

      {/* Progress tracker */}
      <div style={{ margin: "0 16px 16px", padding: 14, background: "var(--card)", border: "1px solid var(--border)", borderRadius: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
          <div style={{ fontSize: 12, fontWeight: 500 }}>💻 Configurar roteador · R$65</div>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
            ...
            <div style={{ fontSize: 10, color: "#9F67FF", fontWeight: 600 }}>Aceito</div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
            ...
            <div style={{ fontSize: 10, color: "#9F67FF", fontWeight: 600 }}>Início</div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
            ...
            <div style={{ fontSize: 10, color: "#7E7A9A" }}>Conclusão</div>
          </div>
          <div style={{ flex: 1, height: 2, background: "rgba(126,122,154,.2)", margin: "0 6px", marginBottom: 16 }} />
          {/* Step 4 - Pagamento */}
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
            <div style={{ width: 28, height: 28, background: "rgba(126,122,154,.12)", border: "2px solid rgba(126,122,154,.2)", borderRadius: "50%" }} />
            <div style={{ fontSize: 10, color: "#7E7A9A" }}>Pagamento</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "4px 22px", display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <div style={{ fontSize: 12, color: "#7E7A9A", lineHeight: 1.4 }}>A foto é usada para confirmar sua presença e proteger ambas as partes de possíveis fraudes.</div>
      </div>
    </div>
  );
}
