    ...
    <>
      <div className="screen" style={{ paddingBottom: 80 }}>
        <div style={{ padding: "16px 22px 12px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 20, fontWeight: 700 }}>Mapa</div>
            <div style={{ fontSize: 12, color: "#7E7A9A", marginTop: 2 }}>Tarefas próximas a você</div>
          </div>
        ...
        {/* Map */}
        <div style={{ margin: "0 16px 12px", height: 300, background: "var(--card)", border: "1px solid var(--border)", borderRadius: 16, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "absolute", bottom: 12, left: 12, background: "rgba(13,11,20,0.8)", borderRadius: 8, padding: "4px 10px", fontSize: 11, color: "#A78BFA", backdropFilter: "blur(8px)" }}>
            Apucarana, PR
          </div>
        </div>
        ...
        <div className="card" onClick={() => navigate("/task/1")} style={{ cursor: "pointer" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              <div className="card-title" style={{ fontSize: 13 }}>Configurar roteador wi-fi</div>
            ...
            <div style={{ textAlign: "right" }}>
              <div className="card-price" style={{ fontSize: 16 }}>R$65</div>
        ...
        <div className="card" onClick={() => navigate("/task/2")} style={{ cursor: "pointer" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              <div className="card-title" style={{ fontSize: 13 }}>Buscar encomenda nos Correios</div>
              <div className="card-meta" style={{ marginTop: 4 }}>
                <svg width="11" height="11" fill="none" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0118 0z" stroke="currentColor" strokeWidth="1.8" /><circle cx="12" cy="10" r="3" stroke="currentColor" strokeWidth="1.8" /></svg>
                0.8 km · Centro
              </div>
            ...
            <div style={{ textAlign: "right" }}>
              <div className="card-price" style={{ fontSize: 16 }}>R$30</div>
