      ...
      <div className="screen" style={{ paddingBottom: 80 }}>
        ...
        <div style={{ padding: "20px var(--hpad)", display: "flex", alignItems: "center", gap: 14 }}>
          <div style={{ position: "relative" }}>
            <div style={{ width: "clamp(54px,16vw,68px)", height: "clamp(54px,16vw,68px)", background: "linear-gradient(135deg,rgba(124,58,237,.4),rgba(159,103,255,.2))", border: "2px solid rgba(138,99,255,.5)", borderRadius: 20, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Syne', sans-serif", fontSize: "clamp(18px,5.5vw,24px)", fontWeight: 800, color: "#A78BFA" }}>L</div>
            <div style={{ position: "absolute", bottom: -4, right: -4, background: "linear-gradient(135deg,#B45309,#D97706)", borderRadius: 6, padding: "2px 5px", fontSize: "clamp(9px,2.5vw,11px)", fontWeight: 700, color: "white", border: "1.5px solid var(--bg)" }}>Nv3</div>
          </div>
          <div style={{ flex: 1 }}>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(16px,4.5vw,20px)", fontWeight: 800 }}>Luiz Oliveira</div>
            <div style={{ fontSize: "clamp(11px,3vw,13px)", color: "#7E7A9A", marginTop: 2 }}>💻 Tech · 📝 Administrativo</div>
            <div style={{ display: "flex", alignItems: "center", gap: 4, marginTop: 6 }}>
              ...
              <span style={{ fontSize: "clamp(10px,2.8vw,12px)", color: "#7E7A9A", marginLeft: 3 }}>4.0 · 7 avaliações</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ margin: "0 var(--hpad) 16px", padding: "clamp(12px,3.5vw,15px)", background: "var(--card)", border: "1px solid var(--border)", borderRadius: 16 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
            <div style={{ fontSize: "clamp(11px,3vw,13px)", color: "#C4B5FD", fontWeight: 600 }}>🏆 Nível 3 — Profissional</div>
            <div style={{ fontSize: "clamp(10px,2.8vw,12px)", color: "#7E7A9A" }}>7 / 15 tarefas</div>
          </div>
          <div className="progress-bar">
            <div className="progress-fill" style={{ width: "47%" }} />
          </div>
          <div style={{ fontSize: "clamp(10px,2.8vw,12px)", color: "#7E7A9A", marginTop: 6 }}>Mais 8 tarefas para o Nível 4 ✨</div>
        </div>
        ...
        <div className="stat-grid">
          ...
          <div className="stat-card">
            ...
            <div className="stat-val" style={{ fontSize: "clamp(15px,4.5vw,19px)", color: "#9F67FF" }}>R$380</div>
        ...
        {/* Specialties */}
        <div style={{ padding: "0 var(--hpad) 10px" }}>
